package com.company.habrparser.rabbitmq.config;

import com.company.habrparser.rabbitmq.property.ExecutorsProperties;
...
public class ExecutorsConfiguration {
    ...
    public ThreadPoolExecutorFactoryBean coreExecutor() {
        ...
        result.setThreadNamePrefix("habr-parser-e-core-");
        return result;
    }
