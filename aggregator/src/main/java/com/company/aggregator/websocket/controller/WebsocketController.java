package com.company.aggregator.websocket.controller;
...
import com.company.aggregator.rabbitmq.dto.vacancy.SendMessageDto;
...
import com.company.aggregator.websocket.dto.WebSocketReceiveMessageDto;
    ...
    public WebSocketReceiveMessageDto spin(@Payload WebSocketReceiveMessageDto webSocketReceiveMessageDto,
        ...
        CompletableFuture.supplyAsync(() -> {
                    ...
                    try {
                        ...
                        favourites = favouriteService.findFavouritesByUser(user);
