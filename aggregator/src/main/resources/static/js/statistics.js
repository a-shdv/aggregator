...
function updateSourcesPie() {
    ...
    switch (localStorage.getItem('year')) {
        case '2024':
            domain = ['Рабочий персонал',  'Продажи', 'Транспорт', 'Производство', 'Строительство и недвижимость', 'Инсталляции и сервис', 'Медицина', 'Туризм', 'Бухгалтерия', 'Прочее']
            values = [17.7, 21.7, 21.1, 10.7, 5.9, 4.5, 4.5, 3.7, 3.2, 1.4, 25]
            break;
        case '2023':
            domain = ['Рабочий персонал',  'Транспорт', 'Производство', 'Продажи', 'Строительство и недвижимость', 'Туризм', 'Инсталляции и сервис', 'Медицина', 'Административный персонал', 'Прочее']
            values = [25.3, 14.6, 11.1, 10.3, 5.7, 3.7, 3.3, 2.9, 2.9, 20.3]
            break;
        case '2022':
            domain = ['Рабочий персонал',  'Транспорт', 'Продажи', 'Производство', 'Строительство и недвижимость', 'Медицина и фармацевтика', 'Инсталляции и сервис', 'Туризм', 'Административный персонал', 'Прочее']
            values = [20.0, 13.6, 11.2, 9.0, 5.8, 4.6, 3.9, 3.8, 3.4, 24.7]
            break;
        case '2021':
            domain = ['Рабочий персонал',  'Транспорт', 'Производстова', 'Продажи', 'Медицина', 'Строительство и недвижимость', 'Инсталляции и недвижимость', 'Туризм', 'Наука', 'Прочее']
            values = [20.3, 10.5, 9.8, 9.7, 6.3, 6.0, 4.4, 3.9, 3.4, 25.8]
            break;
        case '2020':
            domain = ['Рабочий персонал',  'Продажи', 'Транспорт', 'Производство', 'Медицина', 'Строительство', 'Инсталляции и сервис', 'Туризм', 'Информационные технологии', 'Прочее']
            values = [19.1, 11.0, 10.1, 9.7, 6.9, 6.2, 3.9, 3.6, 3.2, 26.3]
            break;
        case '2019':
            domain = ['Рабочий персонал', 'Продажи', 'Транспорт', 'Производство', 'Медицина', 'Строительство и недвижимость', 'Туризм', 'Инсталляции и сервис', 'Административный персонал', 'Прочее']
            values = [20.0, 12.8, 10.2, 9.6, 5.5, 5.0, 4.5, 3.5, 3.0, 25.9]
            break;
        case '2018':
            domain = ['Рабочий персонал', 'Продажи','Транспорт', 'Производство', 'Строительство и недвижимость', 'Медицина', 'Туризм', 'Административный персонал', 'Инсталляции и сервис', 'Прочее']
            values = [17.5, 13.7, 9.3, 8.9, 5.1, 4.6, 4.4, 3.8, 3.4, 29.2]
            break;
        case '2017':
            domain = ['Рабочий персонал', 'Продажи', 'Производство', 'Транспорт, логистика', 'Административный персонал', 'Строительство и недвижимость', 'Медицина, фармацевтика', 'Информационные технологии', 'Туризм', 'Прочее']
            values = [15.9, 14.4, 8.3, 8.1, 4.7, 4.7, 4.7, 4.3, 3.9, 30.9]
            break;
        default:
            domain = ['Рабочий персонал', 'Продажи', 'Транспорт, логистика', 'Производство', 'Строительство, недвижимость', 'Инсталляция и сервис', 'Медицина, фармацевтика', 'Туризм, гостиницы, рестораны', 'Бухгалтерия, управленческий учет, финансы предприятия', 'Прочее',]
            values = [17.7, 21.7, 21.1, 10.7, 5.9, 4.5, 4.5, 3.7, 3.2, 1.4, 25]
            break;
    }
